  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-portfolio-navy p-4">
      <div className="max-w-md w-full text-center animate-fade-in">
        ...
        <h1 className="text-5xl font-semibold text-portfolio-highlight mb-4">Ahmed AlMoselhy</h1>
        <h2 className="text-4xl font-bold text-portfolio-white mb-2">Under Maintenance</h2>
        <p className="text-portfolio-slate text-lg mb-8">
          I'm currently working on making improvements to the site. Please check back soon!
        </p>
        ...
        <div className="border-t border-portfolio-slate/20 pt-6">
          ...
          <div className="flex justify-center space-x-4">
            ...
            <a 
              href="https://linkedin.com/in/ahmedmalmoselhy" 
              target="_blank" 
              rel="noopener noreferrer"
              className="p-2 text-portfolio-slate hover:text-portfolio-highlight transition-colors"
              aria-label="LinkedIn"
